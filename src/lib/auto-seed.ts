...
const SERVICES = [
  ...
  {
    id: "banos",
    name_es: "Baño a Domicilio (Pelo Corto)",
    name_en: "Home Bathing (Short Hair)",
    description_es: "¿Cansado del caos al bañar a tu peludo? ¡Lo hago por ti en la comodidad de tu hogar! Servicio exclusivo de baño y mantenimiento higiénico (sin corte de pelo).",
    description_en: "Tired of the chaos of bathing your pet? I do it for you in the comfort of your home! Exclusive bathing and hygiene service (no haircut included).",
    detail_es: "El spa a domicilio para tu peludo. Todos los productos son especializados según el tipo de pelaje. Servicio sin corte de pelo.",
    detail_en: "The at-home spa for your furry friend. All products are specialized for their coat type. No haircut included.",
    card_includes_es: ["Baño profundo con shampoo especializado", "Secado profesional", "Corte de uñas seguro", "Limpieza de oídos"],
    card_includes_en: ["Deep bath with specialized shampoo", "Professional drying", "Safe nail trimming", "Ear cleaning"],
    includes_es: ["Baño profundo con shampoo especializado", "Secado profesional", "Corte de uñas seguro", "Limpieza de oídos", "Cepillado para eliminar pelo muerto", "Perfume y accesorio de regalo"],
    includes_en: ["Deep bath with specialized shampoo", "Professional drying", "Safe nail trimming", "Ear cleaning", "Brushing to remove dead hair", "Perfume and gift accessory"],
    ideal_es: "Labradores, Golden, Pugs, Beagles, Boxers, Huskies y mestizos de pelo corto",
    ideal_en: "Labradors, Goldens, Pugs, Beagles, Boxers, Huskies, and short-hair mixed breeds",
    ...
    conditions_es: ["Precio varía según raza, tamaño y estado del pelaje", "No incluye corte de pelo"],
    conditions_en: ["Price varies by breed, size, and coat condition", "Haircut not included"],
    footer_note_es: "", footer_note_en: "",
  ...
  },
  {
    ...
    description_en: "You want your dog to be part of your special day... but who will take care of them while you're busy enjoying the moment? That's where I come in. ❤️",
    ...
    detail_en: "As your dog's dedicated companion during the event, I'll stay by their side, supervise them, provide potty breaks, assist with photos, and make sure they're comfortable, safe, and happy throughout the celebration.",
    ...
    includes_en: ["Stay by their side throughout the event", "Potty breaks and walks as needed", "Water, snacks, and personalized attention", "Assistance during photos and special moments", "Monitoring for stress or discomfort signals", "Updates and photos for your peace of mind", "Medication administration if necessary"],
    ...
    ideal_en: "💍 Weddings · 💍 Engagements & Proposals · 📸 Photo Sessions · 🎂 Birthday Celebrations · 🎉 Special Events",
    ...
    benefits_en: ["No stress. No interruptions.", "No asking guests or family to watch your dog.", "Peace of mind knowing your best friend is being cared for.", "Your dog participates safely and comfortably."],
    ...
    price_note_en: "Rates start at $80,000 for the first 2 hours · $30,000/additional hour",
    ...
    conditions_en: ["The service is provided only during the event", "Pet must be up to date on vaccinations and in good health", "A prior meet-and-greet is recommended", "Subject to date and location availability", "High-energy breed pricing may vary"],
    ...
    footer_note_en: "Because your dog is family too, and special moments should be enjoyed, not managed. 🐾❤️",
    unit_es: "evento", unit_en: "event",
    icon: "camera", order: 3,
  },
  {
    id: "pernocta",
    name_es: "Cuidado de Mascotas en Tu Hogar (Pernocta)",
    name_en: "Pet Care at Your Home (Overnight)",
  ...
  },
  {
    ...
    ideal_es: "Perros de cualquier tamaño que necesitan un hogar temporal lleno de amor.",
    ideal_en: "Dogs of any size that need a temporary loving home.",
    price_large: "40.000", price_small: "",
    price_note_es: "Perros pequeños: $40.000/noche · Perros grandes: $60.000/noche",
    price_note_en: "Small dogs: $40,000/night · Large dogs: $60,000/night",
