...
const SERVICES = [
  {
    ...
    description_es: "¿Tu mascota no puede quedarse sola todo el día? Voy a tu casa hasta tres veces al día para darle agua, comida, compañía y un paseo corto. Regreso a casa y vuelvo cuando lo necesite. Ideal para mascotas independientes que solo necesitan supervisión y atención puntual.",
    description_en: "Can't your pet be home alone all day? I'll visit your place up to three times a day to give them water, food, company, and a short walk. I head home and come back whenever needed. Perfect for independent pets that just need occasional check-ins and attention.",
    detail_es: "Perfecto para personas que necesitan apoyo puntual sin cuidado de tiempo completo. Muy útil para gatos, perritos independientes o cuando estás fuera por el día.\n\nSe aplica un cargo de transporte según la ubicación.",
    detail_en: "Perfect for people who need occasional support without full-time care. Very useful for cats, independent dogs, or when you're out for the day.\n\nA transportation charge applies depending on location.",
  ...
  },
  {
    ...
    includes_es: ["Alojamiento cómodo, limpio y seguro", "Rutina de paseos, alimentación y juegos", "Fotos y actualizaciones diarias", "Supervisión constante (solo cuido una mascota a la vez)", "Aplicación de medicamentos si necesitas"],
    includes_en: ["Comfortable, clean, and safe accommodation", "Daily walks, feeding, and playtime", "Daily photos and updates", "Constant supervision (one pet at a time only)", "Medication administration if needed"],
  ...
  },
  {
    ...
    name_en: "Hourly Care",
    description_es: "¿Necesitas unas horas de cuidado puntual? Atención dedicada para tu mascota por hora, ideal para visitas cortas o necesidades específicas.",
    description_en: "Need a few hours of dedicated care? Hourly attention for your pet, ideal for short visits or specific needs.",
    ...
    ideal_es: "", ideal_en: "", why_higher_es: [], why_higher_en: [], benefits_es: [], benefits_en: [],
    price_large: "15.000", price_small: "",
    price_note_es: "Se aplica cargo de transporte según ubicación.",
    price_note_en: "Transportation charge applies depending on location.",
  ...
  },
  {
    ...
    includes_es: ["Alojamiento espacioso, limpio y seguro", "Rutina de paseos largos y ejercicio", "Fotos y actualizaciones diarias", "Supervisión constante (solo cuido una mascota a la vez)", "Aplicación de medicamentos si necesitas"],
    includes_en: ["Spacious, clean, and safe accommodation", "Long walks and exercise routine", "Daily photos and updates", "Constant supervision (one pet at a time only)", "Medication administration if needed"],
