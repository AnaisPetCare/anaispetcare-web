...
const SERVICES = [
  ...
  },
  {
    ...
    name_en: "Hourly Care",
    description_es: "También tengo servicios por horas. Si necesitas que solo cuide a tu mascota por unas horas, sin necesidad de quedarme todo el día, también te puedo ayudar.",
    description_en: "I also offer hourly care. If you just need someone to look after your pet for a few hours — without needing me all day — I can help.",
