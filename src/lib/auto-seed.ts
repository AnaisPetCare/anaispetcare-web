...
const SERVICES = [
  {
    ...
    description_es: "¿Necesitas que alguien visite a tu mascota durante el día? Ofrezco visitas para alimentación, compañía, paseos, tiempo de juego y cuidados generales.",
    description_en: "Need someone to visit your pet during the day? I offer visits for feeding, companionship, walks, playtime, and general care.",
